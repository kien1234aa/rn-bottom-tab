...
import { StyleSheet, Animated, Pressable, View, Text, Platform } from 'react-native';
...
function TabItemComponent({
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement(Animated.View, { style: [styles.container, { transform: [{ scale: pressScale }] }] }, showIndicator && /* @__PURE__ */ React2.createElement(Animated.View, { style: [
      styles.indicator,
      {
    ...
    ] }), /* @__PURE__ */ React2.createElement(Animated.View, { style: {
      transform: [{ scale: iconScale }, { translateY: iconTranslateY }],
      position: "relative"
    } }, /* @__PURE__ */ React2.createElement(Animated.Text, { style: { color: animatedIconColor } }, tab.icon({ focused, color: focused ? activeColor : inactiveColor, size: iconSize })), tab.badge !== void 0 && tab.badge !== 0 && /* @__PURE__ */ React2.createElement(View, { style: styles.badge }, /* @__PURE__ */ React2.createElement(Text, { style: styles.badgeText }, typeof tab.badge === "number" && tab.badge > 99 ? "99+" : tab.badge))), showLabel && /* @__PURE__ */ React2.createElement(
      Animated.Text,
      {
        style: [
          styles.label,
...
function BottomTab({
  ...
  const circleLeftAnim = useRef(null);
  ...
  const shadowStyle = showShadow ? (_a = Platform.select({
    ios: { shadowColor: "#000", shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.06, shadowRadius: 8 },
    android: { elevation: 8 }
  })) != null ? _a : {} : {};
  const circleShadow = showCircleShadow ? (_b = Platform.select({
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    containerWidth > 0 && effectiveCx > 0 && !slidingIndicator ? /* @__PURE__ */ React2.createElement(
      Svg,
      {
      ...
      /* @__PURE__ */ React2.createElement(Path, { d: buildNotchPath(containerWidth, tabBarHeight, effectiveCx, circleR), fill: backgroundColor })
    ) : /* @__PURE__ */ React2.createElement(View, { style: [StyleSheet.absoluteFill, {
      backgroundColor,
      borderTopWidth: showBorder ? StyleSheet.hairlineWidth : 0,
      borderTopColor: borderColor
    }, shadowStyle] }),
    slidingIndicator && containerWidth > 0 && /* @__PURE__ */ React2.createElement(Animated.View, { style: {
      position: "absolute",
      top: extraH + pillTop,
    ...
    isSlidingCircle && circleLeftAnim.current && containerWidth > 0 && !slidingIndicator && /* @__PURE__ */ React2.createElement(Animated.View, { style: [styles2.circle, circleShadow, {
    ...
    hasFeatured && !slidingIndicator && /* @__PURE__ */ React2.createElement(Animated.View, { style: [styles2.circle, circleShadow, {
      width: featuredTabSize,
      height: featuredTabSize,
      borderRadius: circleR,
      backgroundColor: featuredTabColor,
    ...
    /* @__PURE__ */ React2.createElement(View, { style: [styles2.tabsRow, {
      height: tabBarHeight,
      position: "absolute",
      ...
      if (tab.key === featuredTabKey) {
        return /* @__PURE__ */ React2.createElement(View, { key: tab.key, style: styles2.featuredSlot }, showLabel && /* @__PURE__ */ React2.createElement(
          Text,
          {
            style: [
...
export { BottomTab, TabItemComponent };
